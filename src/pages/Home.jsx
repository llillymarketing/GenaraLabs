    ...
    <div className="bg-[#f8faff]">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] tracking-tight">
                Precision<br />
                <span className="bg-gradient-to-r from-[#4fc3f7] to-[#2b7de9] bg-clip-text text-transparent">
                  Peptide Science
                </span><br />
                Starts Here
              </h1>
              ...
              <p className="mt-6 text-lg text-white/60 leading-relaxed max-w-md">
                Laboratory-grade research peptides with verified purity,
                batch-specific certificates of analysis, and rigorous third-party quality control.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mt-10">
                <Link
                  to={createPageUrl('Products')}
                  className="inline-flex items-center justify-center gap-2 bg-[#2b7de9] hover:bg-[#3b8ef0] text-white font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 text-sm shadow-lg shadow-[#2b7de9]/30"
                >
                  Browse Catalog
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 border border-white/20 hover:border-white/40 text-white/80 hover:text-white font-medium px-8 py-3.5 rounded-xl transition-all duration-200 text-sm"
                >
                  About Our Lab
                </Link>
              </div>
            ...
            >
              <div className="relative">
                ...
                <img
                  src="https://media.base44.com/images/public/69b1b9537ee76e31a86fda3a/008601940_GenaraLabsLogo-modified1.png"
                  alt="Genara Labs"
                  className="relative w-80 h-80 object-contain rounded-full shadow-2xl shadow-[#2b7de9]/30"
                />
              </div>
            </motion.div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1a2d5a] mb-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl border border-[#e2e8f5] p-8 hover:shadow-lg hover:border-[#bfdbfe] transition-all duration-300"
            >
        ...
        <div className="mt-14 text-center">
          <Link
            to={createPageUrl('Products')}
            className="inline-flex items-center gap-2 bg-[#1a2d5a] hover:bg-[#243666] text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-sm shadow-lg"
          >
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <Link
                to={createPageUrl('About')}
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#4fc3f7] hover:text-white transition-colors"
              >
