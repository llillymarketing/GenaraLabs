    ...
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="text-sm text-amber-800 leading-relaxed">
          ...
          <p>For Research Use Only. Not for Human Consumption. Not FDA Approved. Not a Dietary Supplement. These products have not been evaluated or approved by the FDA and are intended strictly for laboratory and research purposes.</p>
        </div>
      </div>
    </div>
  );
